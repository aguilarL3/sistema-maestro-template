...
- Experiencias laborales (`01_Experiences/`) — una carpeta por puesto/empresa
- Skills demostrables (`02_Skills/`) — una nota por skill, con evidencia
- Proyectos de portfolio (`03_Projects/`) — enlazan a `03 Proyectos/`, no los copian
- Historias STAR (`04_Career_Stories/`) — munición de entrevista
- CV maestro (`07_CV_Master/`) — fuente de verdad de la que salen variantes
