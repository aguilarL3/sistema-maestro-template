...
|---|---|---|
| **Frescura** | Por fecha (`ultima_revision` vs hoy) | Un SOP sin tocar hace 120 días |
...
- **Dependencias:** Docs con `ultima_revision`; el [[CHANGELOG del Sistema]] al día (el Nivel 1 lo cruza para detectar archivos movidos).
...
DIMENSIÓN 1 — FRESCURA (fechas)
  └─ compara ultima_revision vs hoy → vencido / por vencer / fresco / sin fecha
...
|---|---|---|---|---|
| 1 | Doc con `ultima_revision` de +120 días | Aparece como vencido (frescura) | ⬜ N/A | No hay docs tan viejos aún |
| 2 | Todo fresco | Informe "sin vencidos" | ✅ 2026-06-26 | 0 vencidos reportado |
| 3 | Doc sin `ultima_revision` | "sin fecha" sin abortar | ✅ 2026-06-26 | 29 sin fecha, sin abortar |
...
- Depende de que el [[CHANGELOG del Sistema]] esté al día para detectar archivos movidos.
...
- [[Skill - Revisión Mensual]] → orquestador que corre esta + Cerebro Audit en paralelo
- [[Skill - Cerebro Audit]] → audita estructura/conexiones; complementa la dimensión consistencia
...
**Internas:**
- [[Conflicto Semántico - Enlaces y Contradicciones]] — el Nivel 0 (checkers) y cómo leer sus salidas
- [[Catálogo de Hooks y Locks]] — fichas de `check-links.sh` / `check-contradictions.sh`
- [[SOP Interoperabilidad IA]] — §8 (mantenimiento y el `date.now()`)
- [[SOP Conectores]] — §6 (cuándo actualizar un conector)
- [[SOP Skills]] — §13 (flujo hallazgo → resolución → changelog)
- [[Tipos de Documentación]] — convenciones que el Nivel 1 verifica
- [[CHANGELOG del Sistema]] — fuente para detectar archivos movidos
- [[Blueprint de Sistemas]] · [[AGENTS]]
...
- **Drift de consistencia / obsolescencia de criterio** — ver [[Glosario de términos]].

---

◀ [[Skill - Cerebro Audit]] | MOC: [[Catálogo de Skills]] | [[Skill - Revisión Mensual]] ▶
