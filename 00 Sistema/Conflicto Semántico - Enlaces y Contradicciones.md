...
>Conflicto semántico entre agentes (el porqué) | [[Orquestación Multi-Agente Abierta]] (§13.3) | [[Catálogo de Hooks y Locks]] | [[SOP Hooks y Automatización]] | [[Skill - Mantenimiento Sistema]]
...
1. **Roto real** → el destino existía y se movió/renombró/borró. **Se arregla** (reapuntar el enlace o restaurar el destino). Ej.: `[[01 Index/Dashboard CEO]]` → `[[Dashboard-CEO]]` tras una consolidación.
...
- **En la revisión mensual / mantenimiento:** ambos checkers (candidatos a integrarse en [[Skill - Mantenimiento Sistema]]).
...
## 5. Referencias
- Por qué existe esta frontera → [[Orquestación Multi-Agente Abierta]] §13.3
- Qué hace cada herramienta → [[Catálogo de Hooks y Locks]] (Auditoría CLI)
