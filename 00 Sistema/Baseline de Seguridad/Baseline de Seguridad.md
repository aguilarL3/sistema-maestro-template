---
tipo_doc: How-to
aliases: ["Baseline de Seguridad"]
tags: [seguridad, baseline, portabilidad, claude-code, cadena-de-suministro]
estado: 🟢 Activo
prioridad: 🔥 Alta
responsable: "{{OWNER}}"
id: "HOW-SEGURIDAD-BASELINE-001"
ultima_revision: 2026-07-09
fecha_creacion: 2026-07-09
---

>[!info] Documentación relacionada
>[[SOP de Seguridad]] (el marco completo) | [[Prompt Injection y la Tríada Letal]] | [[Cadena de Suministro y Código de Terceros]] | [[MOC - Seguridad]]

# Baseline de Seguridad — kit portable para proyectos externos

> Kit mínimo, copiable en **cualquier proyecto de código** (no un vault), para que nazca con seguridad determinista. Es la versión reducida de lo que el [[SOP de Seguridad]] hace en el vault. Distinto del **template del Sistema Maestro** (que es para clonar el vault entero); esto es solo la capa de seguridad para un repo cualquiera.
...
Defensa en profundidad: si una capa falla, otra ataja. Detalle en [[SOP de Seguridad]] §2
y [[Prompt Injection y la Tríada Letal]].

## Cómo leer este doc
Es un How-to. Seguí los 5 pasos, pegá la sección, reabrí Claude Code. Para el marco
conceptual completo, andá al [[SOP de Seguridad]].
