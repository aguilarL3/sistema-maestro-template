...
3. **Brújula (01 Index).** Entrevistá para llenar los stubs — máximo 2-3 preguntas por doc, respuestas cortas valen:
   ...
   Escribí cada doc con lo que responda (estado 🟢 Activo, ultima_revision = hoy). Si el usuario quiere saltear alguno, dejá el stub y anotalo como pendiente en el propio doc.
...
- Respetá el frontmatter canónico (tipo_doc/estado/ultima_revision) en los docs que escribas.
