...
2. Lanzá DOS subagentes en paralelo con la herramienta Task:
   ...
   (1) FRESCURA: para cada doc con `generated.at` (OKF v0.2; o `timestamp`/`fecha_actualizacion` legacy), calculá días hasta hoy. Marcá vencidos (+90d) y por vencer (60-90d).
