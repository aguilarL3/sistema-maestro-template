...
# Ver concepto en [[Verifier pre-commit (self-review)]] y [[Verificación determinista
# vs criterio del agente]]. Sin jq, sin node.
#
...
#             ultima_revision, id) o no hay frontmatter.  (SOP Documentación §8)
...
# Zonas donde el frontmatter (4 campos SOP Documentación) es obligatorio, y
